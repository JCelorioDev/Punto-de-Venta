...
<head>
	...
	<title>Comisariato Cleymer</title>
...
<body>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<a class="sidebar-brand" href="index.html" style="background: rgb(140, 174, 114)">
				<svg>
					<img width="100px" height="100px" src="img/brands/images.png" alt="">
				</svg>
                <br>
				<span style="font-family: 'Paytone One', sans-serif">Comisariato - Cleymer</span>
			</a>
			<div class="sidebar-content">
				<div class="sidebar-user">
					<img src="img/avatars/avatar-6.jpg" class="img-fluid rounded-circle mb-2" alt="Linda Miller" />
					<div class="fw-bold">Jahir Alexander Celorio Malavé</div>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a data-bs-target="#dashboards" data-bs-toggle="collapse" class="sidebar-link">
							<i class="align-middle me-2 fas fa-fw fa-shopping-cart"></i> <span class="align-middle">Productos</span>
						</a>
						<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							<li class="sidebar-item active"><a class="sidebar-link" href="{{url('Ventas')}}">Registro</a></li>
					...
					<li class="sidebar-item">
						<a data-bs-target="#pages" data-bs-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle me-2 fas fa-fw fa-coins"></i> <span class="align-middle">Facturación</span>
						</a>
					...
					<li class="sidebar-item">
						<a data-bs-target="#auth" data-bs-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle me-2 fas fa-fw fa-sign-in-alt"></i> <span class="align-middle">Salir</span>
						</a>
